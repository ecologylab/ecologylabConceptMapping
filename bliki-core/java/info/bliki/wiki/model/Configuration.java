...
public class Configuration implements IConfiguration {
	...
	private static final String[] INTERWIKI_STRINGS = { "be-x-old", "http://be-x-old.wikipedia.org/wiki/${title}", "tavi",
			...
			"war", "http://war.wikipedia.org/wiki/${title}",
			"new", "http://new.wikipedia.org/wiki/${title}",
			"ceb", "http://ceb.wikipedia.org/wiki/${title}",
			"pms", "http://pms.wikipedia.org/wiki/${title}",
			"bpy", "http://bpy.wikipedia.org/wiki/${title}",
			"lmo", "http://lmo.wikipedia.org/wiki/${title}",
			"zh-yue", "http://zh.wikipedia.org/wiki/${title}",
			"nap", "http://nap.wikipedia.org/wiki/${title}",
			"bat-smg", "http://bat.wikipedia.org/wiki/${title}",
			"ksh", "http://ksh.wikipedia.org/wiki/${title}",
			"roa-tara", "http://roa.wikipedia.org/wiki/${title}",
			"vec", "http://vec.wikipedia.org/wiki/${title}",
			"pam", "http://pam.wikipedia.org/wiki/${title}",
			"sah", "http://sah.wikipedia.org/wiki/${title}",
			"arz", "http://arz.wikipedia.org/wiki/${title}",
			"hsb", "http://hsb.wikipedia.org/wiki/${title}",
			"glk", "http://glk.wikipedia.org/wiki/${title}",
			"gan", "http://gan.wikipedia.org/wiki/${title}",
			"pnb", "http://pnb.wikipedia.org/wiki/${title}",
			"bcl", "http://bcl.wikipedia.org/wiki/${title}",
			"fiu-vro", "http://fiu.wikipedia.org/wiki/${title}",
			"nds-nl", "http://nds.wikipedia.org/wiki/${title}",
			"bar", "http://bar.wikipedia.org/wiki/${title}",
			"nrm", "http://nrm.wikipedia.org/wiki/${title}",
			"pag", "http://pag.wikipedia.org/wiki/${title}",
			"map-bms", "http://map.wikipedia.org/wiki/${title}",
			"sco", "http://sco.wikipedia.org/wiki/${title}",
			"diq", "http://diq.wikipedia.org/wiki/${title}",
			"wuu", "http://wuu.wikipedia.org/wiki/${title}",
			"lij", "http://lij.wikipedia.org/wiki/${title}",
			"nov", "http://nov.wikipedia.org/wiki/${title}",
			"mzn", "http://mzn.wikipedia.org/wiki/${title}",
			"ilo", "http://ilo.wikipedia.org/wiki/${title}",
			"zh-classical", "http://zh.wikipedia.org/wiki/${title}",
			"lad", "http://lad.wikipedia.org/wiki/${title}",
			"cbk-zam", "http://cbk.wikipedia.org/wiki/${title}",
			"frp", "http://frp.wikipedia.org/wiki/${title}",
			"hak", "http://hak.wikipedia.org/wiki/${title}",
			"ckb", "http://ckb.wikipedia.org/wiki/${title}",
			"hif", "http://hif.wikipedia.org/wiki/${title}",
			"xal", "http://xal.wikipedia.org/wiki/${title}",
			"szl", "http://szl.wikipedia.org/wiki/${title}",
			"pdc", "http://pdc.wikipedia.org/wiki/${title}",
			"stq", "http://stq.wikipedia.org/wiki/${title}",
			"crh", "http://crh.wikipedia.org/wiki/${title}",
			"ace", "http://ace.wikipedia.org/wiki/${title}",
			"myv", "http://myv.wikipedia.org/wiki/${title}",
			"krc", "http://krc.wikipedia.org/wiki/${title}",
			"ext", "http://ext.wikipedia.org/wiki/${title}",
			"mhr", "http://mhr.wikipedia.org/wiki/${title}",
			"eml", "http://eml.wikipedia.org/wiki/${title}",
			"pcd", "http://pcd.wikipedia.org/wiki/${title}",
			"kab", "http://kab.wikipedia.org/wiki/${title}",
			"pap", "http://pap.wikipedia.org/wiki/${title}",
			"zea", "http://zea.wikipedia.org/wiki/${title}",
			"srn", "http://srn.wikipedia.org/wiki/${title}",
			"udm", "http://udm.wikipedia.org/wiki/${title}",
			"dsb", "http://dsb.wikipedia.org/wiki/${title}",
			"rmy", "http://rmy.wikipedia.org/wiki/${title}",
			"cu", "http://cu.wikipedia.org/wiki/${title}",
			"mwl", "http://mwl.wikipedia.org/wiki/${title}",
			"mdf", "http://mdf.wikipedia.org/wiki/${title}",
			"kaa", "http://kaa.wikipedia.org/wiki/${title}",
			"tet", "http://tet.wikipedia.org/wiki/${title}",
			"pih", "http://pih.wikipedia.org/wiki/${title}",
			"pnt", "http://pnt.wikipedia.org/wiki/${title}",
			"cdo", "http://cdo.wikipedia.org/wiki/${title}",
			"bug", "http://bug.wikipedia.org/wiki/${title}",
			"lbe", "http://lbe.wikipedia.org/wiki/${title}",
			"bxr", "http://bxr.wikipedia.org/wiki/${title}",
			
			"gag", "http://gag.wikipedia.org/wiki/${title}",
			"frr", "http://frr.wikipedia.org/wiki/${title}",
			"pfl", "http://pfl.wikipedia.org/wiki/${title}",
	};
