...
public class svm {
	...
	{
		double[] kvalueBuffer = new double[model.l];
		return svm_predict_values(model, x, dec_values, kvalueBuffer);
	}
	 ...
	 * @param x
	 * @param dec_values
	 * @param kvalueBuffer a buffer used to reduce memory consumption (and possible GCs).
	 * @return
	 */
	public static double svm_predict_values(svm_model model, svm_node[] x, double[] dec_values, double[] kvalueBuffer)
	{
	...
	{
		double[] kvalueBuffer = new double[model.l];
		return svm_predict_probability(model, x, prob_estimates, kvalueBuffer);
	}

	public static double svm_predict_probability(svm_model model, svm_node[] x, double[] prob_estimates, double[] kvalueBuffer)
	{
		    ...
		    model.probA!=null && model.probB!=null)
		{
			...
			svm_predict_values(model, x, dec_values, kvalueBuffer);
