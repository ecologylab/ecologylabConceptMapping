...
public class WikiResFeatureExtractorEx extends WikiResFeatureExtractor
{
	...
	public WikiResFeatureExtractorEx(String resultFilepath, String... ambiSurfaces) throws IOException
	{
		super(ambiSurfaces);
	...
	public static void main(String[] args)
	{
		try
		{
			...
			WikiResFeatureExtractorEx extractor = new WikiResFeatureExtractorEx(
